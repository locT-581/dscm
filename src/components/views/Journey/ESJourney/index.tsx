  ...
  assessments.map((a) => (
    <tr key={a.id}>
      <table className="LCI-table">
        <caption>
          Enviromental Sustainability Assessment for
        ...
        <tbody>
          ...
          <tr>
            <th rowSpan={2}>
              Energy efficiency <MdIcons.MdPowerOff />
            </th>
            <th>Amount of energy reduced per month</th>
            <td>
              {a.id > 1 && energy[a.id - 2] > 0 && energy[a.id - 1] > 0 ? energy[a.id - 2] - energy[a.id - 1] : null}
            </td>
            <td>kWh/ month</td>
          </tr>
          <tr>
            ...
            <td>
              {(a.id > 1 && energy[a.id - 2] > 0 && energy[a.id - 1] > 0
                ? ((energy[a.id - 2] - energy[a.id - 1]) * 100) / energy[a.id - 2]
                : null) %
                1 !==
              0
                ? (a.id > 1 && energy[a.id - 2] > 0 && energy[a.id - 1] > 0
          ...
          <tr>
            ...
            <td>
              {((a.renewenergy * 100) / a.energy) % 1 !== 0
                ? ((a.renewenergy * 100) / a.energy).toFixed(1)
                : (a.renewenergy * 100) / a.energy}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.waterrec * 100) / a.water) % 1 !== 0
                ? ((a.waterrec * 100) / a.water).toFixed(1)
                : (a.waterrec * 100) / a.water}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            <th rowSpan={2}>
              Material efficiency <AiIcons.AiFillGold />
            </th>
            <th>Amount of materials reduced per month</th>
            <td>
              {a.id > 1 && material[a.id - 2] > 0 && material[a.id - 1] > 0
                ? material[a.id - 2] - material[a.id - 1]
                : null}
            </td>
            <td>kg/ month</td>
          </tr>
          <tr>
            ...
            <td>
              {(a.id > 1 && material[a.id - 2] > 0 && material[a.id - 1] > 0
                ? ((material[a.id - 2] - material[a.id - 1]) * 100) / material[a.id - 2]
                : null) %
                1 !==
              0
                ? (a.id > 1 && material[a.id - 2] > 0 && material[a.id - 1] > 0
          ...
          <tr>
            ...
            <td>
              {((a.materialrec * 100) / a.material) % 1 !== 0
                ? ((a.materialrec * 100) / a.material).toFixed(1)
                : (a.materialrec * 100) / a.material}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            <th>
              Existence of activities and operations on protected and sensitive areas (e.g., IUCN protected area
          ...
          <tr>
            ...
            <td>
              {((a.solidwasterec * 100) / a.solidwaste) % 1 !== 0
                ? ((a.solidwasterec * 100) / a.solidwaste).toFixed(1)
                : (a.solidwasterec * 100) / a.solidwaste}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.waterwasterec * 100) / a.waterwaste) % 1 !== 0
                ? ((a.waterwasterec * 100) / a.waterwaste).toFixed(1)
                : (a.waterwasterec * 100) / a.waterwaste}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.productrec * 100) / a.products) % 1 !== 0
                ? ((a.productrec * 100) / a.products).toFixed(1)
                : (a.productrec * 100) / a.products}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.ecolabel * 100) / a.products) % 1 !== 0
                ? ((a.ecolabel * 100) / a.products).toFixed(1)
                : (a.ecolabel * 100) / a.products}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.envirosus * 100) / a.suppliers) % 1 !== 0
                ? ((a.envirosus * 100) / a.suppliers).toFixed(1)
                : (a.envirosus * 100) / a.suppliers}
            </td>
            <td>%</td>
          </tr>
        </tbody>
      ...
      <table className="LCI-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              {((a.trainemp * 100) / a.emp) % 1 !== 0
                ? ((a.trainemp * 100) / a.emp).toFixed(1)
                : (a.trainemp * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.fullemp * 100) / a.emp) % 1 !== 0
                ? ((a.fullemp * 100) / a.emp).toFixed(1)
                : (a.fullemp * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {(((a.emp - a.fullemp) * 100) / a.emp) % 1 !== 0
                ? (((a.emp - a.fullemp) * 100) / a.emp).toFixed(1)
                : ((a.emp - a.fullemp) * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.empwage * 100) / 4250) % 1 !== 0 ? ((a.empwage * 100) / 4250).toFixed(1) : (a.empwage * 100) / 4250}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.minwage * 100) / a.emp) % 1 !== 0
                ? ((a.minwage * 100) / a.emp).toFixed(1)
                : (a.minwage * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.insurance * 100) / a.emp) % 1 !== 0
                ? ((a.insurance * 100) / a.emp).toFixed(1)
                : (a.insurance * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.femboard * 100) / a.empboard) % 1 !== 0
                ? ((a.femboard * 100) / a.empboard).toFixed(1)
                : (a.femboard * 100) / a.empboard}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.disabled * 100) / a.emp) % 1 !== 0
                ? ((a.disabled * 100) / a.emp).toFixed(1)
                : (a.disabled * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.minority * 100) / a.emp) % 1 !== 0
                ? ((a.minority * 100) / a.emp).toFixed(1)
                : (a.minority * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.older * 100) / a.emp) % 1 !== 0 ? ((a.older * 100) / a.emp).toFixed(1) : (a.older * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.empunion * 100) / a.emp) % 1 !== 0
                ? ((a.empunion * 100) / a.emp).toFixed(1)
                : (a.empunion * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.bargain * 100) / a.emp) % 1 !== 0
                ? ((a.bargain * 100) / a.emp).toFixed(1)
                : (a.bargain * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          ...
          <tr>
            ...
            <td>
              {((a.localemp * 100) / a.emp) % 1 !== 0
                ? ((a.localemp * 100) / a.emp).toFixed(1)
                : (a.localemp * 100) / a.emp}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.localsup * 100) / a.suppliers) % 1 !== 0
                ? ((a.localsup * 100) / a.suppliers).toFixed(1)
                : (a.localsup * 100) / a.suppliers}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.donation * 100) / a.earning) % 1 !== 0
                ? ((a.donation * 100) / a.earning).toFixed(1)
                : (a.donation * 100) / a.earning}
            </td>
            <td>%</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {((a.socialsus * 100) / a.suppliers) % 1 !== 0
                ? ((a.socialsus * 100) / a.suppliers).toFixed(1)
                : (a.socialsus * 100) / a.suppliers}
            </td>
            <td>%</td>
          </tr>
          <tr>
            ...
            <td>
              {((a.productassess * 100) / a.product) % 1 !== 0
                ? ((a.productassess * 100) / a.product).toFixed(1)
                : (a.productassess * 100) / a.product}
            </td>
            <td>%</td>
          </tr>
          <tr>
...
const ESJourney = () => {
  ...
  const accountD = params.get("account");
