      ...
      setDivChartData({
        ...
        datasets: [
          ...
          },
          {
            ...
            backgroundColor: "rgb(215, 185, 213)",
          },
          {
            label: "Người lao động",
            data: emp,
      ...
      setEmpChartData({
        ...
        datasets: [
          ...
          },
          {
            ...
            backgroundColor: "rgb(118,111,178)",
          },
          {
      ...
      setGenderChartData({
        ...
        datasets: [
          ...
          },
          {
            ...
            backgroundColor: "rgb(98,195,165)",
          },
          {
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgb(236,113,20)",
          },
          {
            label: "Số giờ làm thêm hàng tuần",
            data: overtimeh,
            borderColor: "rgb(226,117,174)",
            backgroundColor: "rgb(226,117,174)",
          },
        ],
      });
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgb(88, 49, 1)",
          },
          {
            label: "Lao động cưỡng bức",
            data: forced,
            borderColor: "rgb(190, 140, 99)",
            backgroundColor: "rgb(190, 140, 99)",
          },
        ],
      });
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgb(249, 132, 74)",
          },
          {
